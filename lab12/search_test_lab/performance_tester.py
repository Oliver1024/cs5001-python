...
def main():
    ...
    print("--------------Linear search---------------")
    for i in range(1, N):
        test_linear_search(i*N_SIZE, N_TIMES, ordered=False)
        test_linear_search(i*N_SIZE, N_TIMES, ordered=True)

    print("-------------Binary search----------------")
    for i in range(1, N):
        test_binary_search(i*N_SIZE, N_TIMES)

    print("------------------Median-------------------")
    for i in range(1, N):
        test_median(i*N_SIZE_MED, N_TIMES)
